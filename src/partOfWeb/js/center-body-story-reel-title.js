  ...
  return (
    <div className="center-body-story-reel-box">
      <div
        className="story"
        onClick={() => {
          StoryreelSelectorSet("0");
        }}
      >
        <div
          className="title"
          id={storyreelSelector === "0" ? "clickedText" : ""}
        >
        ...
        <div
          className="lineUnder"
          id={storyreelSelector === "0" ? "clicked" : ""}
        ></div>
      </div>
      ...
      <div
        className="reel"
        onClick={() => {
          StoryreelSelectorSet("1");
        }}
      >
        <div
          className="title"
          id={storyreelSelector === "1" ? "clickedText" : ""}
        >
          <svg fill="currentColor" viewBox="0 0 20 20" width="1em" height="1em">
            <g fillRule="evenodd" transform="translate(-446 -350)">
        ...
        <div
          className="lineUnder"
          id={storyreelSelector === "1" ? "clicked" : ""}
        ></div>
      </div>
    </div>
  );
